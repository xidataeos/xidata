...
- (void)initWithUI
{
   ...
   self.imageView1.image = [UIImage qrImageWithContent:[NSString stringWithFormat:@"wowo,0,%@",RCLOUD_ID] logo:[UIImage imageNamed:@"pgoto_girl"] size:260*KWidth_Scale red:20 green:100 blue:100];
