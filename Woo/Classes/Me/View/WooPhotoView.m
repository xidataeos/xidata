...
- (void)initWithUI
{
    ...
    /*
    [self sd_addSubviews:@[self.backgroundView, button3, button2, button1, line]];
    ...
    line.sd_layout
    .bottomSpaceToView(button3, 0)
    .rightEqualToView(button3)
    ...
    button1.sd_layout
    .bottomSpaceToView(button2, 0.5)
    .rightEqualToView(button2)
