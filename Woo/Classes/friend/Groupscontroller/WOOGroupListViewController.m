...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    chatnewcell.textLabel.text=self.titlearr[indexPath.section];
        ...
        //NSArray *iamgess = [[NSArray alloc] initWithObjects:@"9174948_zeG2T.jpeg",@"https://@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1534500551733&di=d6b712de7c4306eb7abcba133fb42918&imgtype=jpg&src=http%3A%2F%2Fimg4.imgtn.bdimg.com%2Fit%2Fu%3D71246494%2C232197247%26fm%3D214%26gp%3D0.jpg",@"htt", nil];
//        [CreatGroupAvatar greateGroupAvatar:iamgess finished:^(NSData *groupAvatar) {
//            newcell.avrimage.image = [UIImage imageWithData:groupAvatar];
//        }];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        ...
        RCConversation *conver=self.dataArray[indexPath.row];
         [[ChatmangerObject ShareManger] gotoChatViewtargetid:conver.targetId convertitle:conver.conversationTitle conversationModelType:conver.conversationType fromview:self];
    }
}
