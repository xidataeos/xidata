...
+(instancetype)messageWithredZize:(NSString *)TranFerZize content:(NSString *)content TranSingleId:(NSString *)TranSingleId
{
    ...
    if (message) {
        ...
        message.TranSingleId=TranSingleId;
    }
    return message;
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.TranSingleId = [aDecoder decodeObjectForKey:@"TranSingleId"];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:self.TranSingleId forKey:@"TranSingleId"];
...
- (NSData *)encode {
    ...
    [dataDict setObject:@"self.TranSingleId" forKey:@"TranSingleId"];
    if (self.TranFerZize) {
...
- (void)decodeWithData:(NSData *)data {
    if (data) {
        ...
        if (dictionary) {
            ...
            self.TranSingleId = dictionary[@"TranSingleId"];
