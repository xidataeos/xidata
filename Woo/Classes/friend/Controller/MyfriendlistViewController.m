    ...
    if (indexPath.section==0) {
            ...
            [share setMyblock:^(NSInteger indexrow) {
                ...
                if (indexrow==0) {
                    ...
                    [[ShareObject defaultShare] addShareImageUrl:@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1535518551554&di=7873e6129333b20ffad2524c3149d570&imgtype=0&src=http%3A%2F%2Fs4.sinaimg.cn%2Fmw690%2F001sB7zxzy74flKL4FJb3%26690" shareText:@"我来子WoWo" shareTitle:@"分享喜悦图" shareUrl:@"www.baidu.com"
                    shareCompletionBlcok:^(SSDKResponseState state) {
                        
                    }];
                    [[ShareObject defaultShare] shareToPlatfrom:mshareToPlatfrom fromecontroller:self ContentType:SSDKContentTypeImage];
            }];
            [share shareviewShow];
    }
