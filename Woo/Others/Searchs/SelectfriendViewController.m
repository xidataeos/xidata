...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    newcell.celltitlable.text=@"张小斐";
    newcell.celltitlable.textColor=WordsofcolorColor;
    newcell.celltitlable.font=DefleFuont;
    newcell.userimageview.image=[UIImage imageNamed:@"pgoto_girl"]; newcell.selectionStyle=UITableViewCellSelectionStyleNone;
...
- (void)cancelButtonClicked {
    if ([self.SearchViewDelegate respondsToSelector:@selector(SelectfriendCancelClick)]) {
        [self.SearchViewDelegate SelectfriendCancelClick];
    }
