...
{
    if (_namelabel==nil) {
        _namelabel=[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.userimage.frame)+5, 15+10, SCREEN_WIDTH*0.7, 20)];
...
-(UILabel *)groupusercount
{
    if (_groupusercount==nil) {
        ...
        _groupusercount.text=[NSString stringWithFormat:@"群成员数%@",self.groupmodel.number];
