...
- (void)searchBarTextDidBeginEditing:(UISearchBar *)searchBar {
    ...
    self.changestatuscolor=YES;
     if (self.chatype==Single_chat) {
          [[WooSearchmanger shareInstance] begintosearch:self navi:self.searchNavigationController search:begin_search_frien];
     }
     else{
          [[WooSearchmanger shareInstance] begintosearch:self navi:self.searchNavigationController search:begin_search_group];
     }
