...
-(UILabel *)countlabel{
    if (_countlabel==nil) {
        _countlabel=[[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH*0.6, 5*KWidth_Scale, SCREEN_WIDTH*0.4-15*KWidth_Scale, 25*KWidth_Scale)];
        _countlabel.textColor=NaviBackgroundColor;
