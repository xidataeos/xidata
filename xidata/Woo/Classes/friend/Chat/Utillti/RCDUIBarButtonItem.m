...
- (RCDUIBarButtonItem *)initWithLeftBarButton:(NSString *)title target:(id)target action:(SEL)method{
    ...
    return [self initContainImage:[UIImage imageNamed:@"whiteback"] imageViewFrame:CGRectMake(0, 2, 22, 22) buttonTitle:title titleColor:[RCIM sharedRCIM].globalNavigationBarTintColor titleFrame:CGRectMake(19, 4, 85, 17) buttonFrame:CGRectMake(-4, 0, 87, 23) target:target action:method];
}
