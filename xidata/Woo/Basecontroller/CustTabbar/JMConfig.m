...
- (void)configNormal {
    _norTitleColor = [PublicFunction colorWithHexString:@"808080"];
    _selTitleColor = NaviBackgroundColor;
    _isClearTabBarTopLine = YES;
    _tabBarTopLineColor = [UIColor blackColor];
    _tabBarBackground = [UIColor whiteColor];
    _typeLayout = JMConfigTypeLayoutNormal;
    _imageSize = CGSizeMake(24, 24);
    _badgeTextColor = [UIColor colorFromHexRGB:@"FFFFFF"];
    _badgeBackgroundColor = [UIColor colorFromHexRGB:@"FF4040"];
    _titleFont = 12.f;
    _titleOffset = 3.f;
    _imageOffset = 3.f;
}
