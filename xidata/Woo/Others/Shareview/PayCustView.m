...
-(UITextField *)passtextfield
{
    if (_passtextfield==nil) {
        ...
        _passtextfield.textColor=NaviBackgroundColor;
        _passtextfield.font=[UIFont systemFontOfSize:18];
        //_passtextfield.secureTextEntry=YES;
        _passtextfield.delegate=self;
        _passtextfield.userInteractionEnabled=NO;
        _passtextfield.text=[NSString stringWithFormat:@"%@ 枚",detaistr];
