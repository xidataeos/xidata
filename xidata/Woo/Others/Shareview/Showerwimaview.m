...
-(UIImageView *)userimageview
{
    if (_userimageview==nil) {
        ...
        [_userimageview sd_setImageWithURL:[NSURL URLWithString:self.groupinfo.portraitUri] placeholderImage:[UIImage imageNamed:@"photo_boy"]];
...
-(UIImageView *)erweimaimageview
{
    if (_erweimaimageview==nil) {
       ...
       _erweimaimageview.image =[UIImage qrImageWithContent:[NSString stringWithFormat:@"wowo,1,%@",self.groupinfo.groupId] logo:self.userimageview.image size:260*KWidth_Scale red:20 green:100 blue:100];
    }
