...
+ (void)configNowPlayingInfoCenter {
    if (NSClassFromString(@"MPNowPlayingInfoCenter")) {
        ...
        MusicEntity *music = [audioViewController sharedInstance].currentPlayingMusic;
        ...
        [dict setObject:[audioViewController sharedInstance].musicTitle forKey:MPMediaItemPropertyAlbumTitle];
